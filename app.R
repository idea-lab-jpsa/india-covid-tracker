...
colnames(this_week_all) <- c("State","District","Daily New Cases (7-day average)", "Growth Rate % (7-day average)", "Doubling Time (in days)", "Test Positivity Rate (%)", "Persons vaccinated with at least one dose", "Cumulative % of Population vaccinated with at least one dose")
...
colnames(last_week_all) <- c("State","District","Daily New Cases (7-day average)", "Growth Rate % (7-day average)", "Doubling Time (in days)", "Test Positivity Rate (%)", "Persons vaccinated with at least one dose", "Cumulative % of Population vaccinated with at least one dose")
...
colnames(last_month_all) <- c("State","District","Daily New Cases (7-day average)", "Growth Rate % (7-day average)", "Doubling Time (in days)", "Test Positivity Rate (%)", "Persons vaccinated with at least one dose", "Cumulative % of Population vaccinated with at least one dose")
...
tw_lw_trend %>%
  select("State","District","Daily New Cases (7-day average) This Week", "Daily New Cases (7-day average) Last Week", "Daily Cases Trend (This Week v Last Week)",
         ...
         "Cumulative % of Population vaccinated with at least one dose This Week", "Cumulative % of Population vaccinated with at least one dose Last Week") -> tw_lw_final
...
tw_lm_trend %>%
  select("State","District","Daily New Cases (7-day average) This Week", "Daily New Cases (7-day average) Last Month", "Daily Cases Trend (This Week v Last Month)",
         ...
         "Cumulative % of Population vaccinated with at least one dose This Week", "Cumulative % of Population vaccinated with at least one dose Last Month") -> tw_lm_final
...
colnames(this_week_state) <- c("State","Population","Daily New Cases (7-day average)", "Test Positivity Rate (%)", "Persons vaccinated with at least one dose","Cumulative % of Population vaccinated with at least one dose")
...
colnames(last_week_state) <- c("State","Daily New Cases (7-day average)", "Test Positivity Rate (%)", "Persons vaccinated with at least one dose","Cumulative % of Population vaccinated with at least one dose")
...
colnames(last_month_state) <- c("State","Daily New Cases (7-day average)", "Test Positivity Rate (%)", "Persons vaccinated with at least one dose","Cumulative % of Population vaccinated with at least one dose")
...
tw_lw_trend_state %>%
  select("State","Daily New Cases (7-day average) This Week", "Daily New Cases (7-day average) Last Week", "Daily Cases Trend (This Week v Last Week)",
         "Test Positivity Rate (%) This Week", "Test Positivity Rate (%) Last Week", "Test Positivity Rate Trend (This Week v Last Week)",
         "Persons vaccinated with at least one dose This Week", "Cumulative % of Population vaccinated with at least one dose This Week",
         "Persons vaccinated with at least one dose Last Week", "Cumulative % of Population vaccinated with at least one dose Last Week") -> tw_lw_final_state
...
tw_lm_trend_state %>%
  select("State","Daily New Cases (7-day average) This Week", "Daily New Cases (7-day average) Last Month", "Daily Cases Trend (This Week v Last Month)",
         "Test Positivity Rate (%) This Week", "Test Positivity Rate (%) Last Month", "Test Positivity Rate Trend (This Week v Last Month)",
         "Persons vaccinated with at least one dose This Week", "Cumulative % of Population vaccinated with at least one dose This Week",
         "Persons vaccinated with at least one dose Last Month", "Cumulative % of Population vaccinated with at least one dose Last Month") -> tw_lm_final_state
...
ui <- fluidPage (
  ...
  tags$a(onclick = "onclick =window.open('https://github.com/idea-lab-jpsa/india-covid-tracker/blob/main/README.md')",
         href = NULL,
         icon("github", "fa-3x"),
         title = "GitHub",
         style = "cursor: pointer;margin-left:1800px"),
